...
export function ReservationConfirmationClient() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-ceylon-volcanic text-ceylon-ivory flex items-center justify-center">Loading booking confirmation...</div>}>
      <ConfirmationInner />
    </Suspense>
  );
}
