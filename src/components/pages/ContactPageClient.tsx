...
import { MapPin, Phone, MessageCircle, Clock, Send, Sparkles } from "lucide-react";
          ...
          <ul className="space-y-6 text-sm">
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-800 font-medium mt-0.5">{settings?.address || "44 Mayflower St, Plymouth PL1 1QX"}</p>
              </div>
            </li>
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href={formattedCallHref} className="text-[#071B5C] font-bold hover:underline mt-0.5 block">
                  {settings?.mobileNumber || "01752 941504"}
                </a>
              </div>
            </li>
